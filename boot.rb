...
AWS_ACCESS_KEY = 'deleted'
AWS_SECRET_ACCESS_KEY = 'deleted'
AWS_IOT_URL = 'a11orpone228jn.iot.us-east-2.amazonaws.com' # should be like xxxxx.amazonaws.com
KEY_FILE_NAME = 'bed554ec32-private.pem.key' # .key file name under certs folder
CERT_FILE_NAME = 'bed554ec32-certificate.pem.crt' # .crt file name under certs folder
CA_FILE_NAME = 'VeriSign.pem' # .pem file name for rootCA.pem file
